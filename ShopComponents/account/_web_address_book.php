<div class="web_address">
	...
	<div class="_address_col">
			...
			<?php 
			 ...
			 <?php if (mysqli_num_rows($result_address) == 0): ?>
		 		<div class="web_saved_add">
		 			<h4>SAVED ADDRESS</h4>
		 			<small>You haven't added any shipping address</small>
		 		</div>
			 <?php 	else: ?>
		...
		<div class="_web_right_content m_web_full_content">
			...
			<small>* Required Feilds</small>
			<form action="lib/add_address.php" method="POST" id="address_form">				
				<div class="_web_register">				
					<ul>
						...
						<li>
							...
							<input type="text" name="address_rep_name">
						</li>

						<li>
							<label>LAST NAME*</label>
							<input type="text" name="address_rep_last_name">
						</li>


						<li>
							<label>PHONE NUMBER</label>
							<input type="text" name="address_rep_phone_number">
						</li>
					...
					<div class="_web_terms_condition">
						<input type="checkbox">
						<p>Make This My Default Billing Address</p>
						<div class="web_clear_content"></div>
					</div>

					<button id="add_address" type="button">SAVE ADDRESS</button>
				</div>
			</form>
		</div>
